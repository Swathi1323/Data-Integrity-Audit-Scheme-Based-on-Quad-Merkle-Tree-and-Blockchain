    ...
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
            <li><span class="style3"><span class="style4"><a href="TPA_Hash_Table.jsp">View Data Blocks </a></span></span></li>
